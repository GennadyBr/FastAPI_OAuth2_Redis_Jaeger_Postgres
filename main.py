...
class User(Base):
    ...
    hashed_password = Column(String, default='None') # пока строка
    role_id = Column(UUID(as_uuid=True), default='12345678-1234-1234-1234-123456789012') #
    history = Column(String, default='None') # пока строка
    ...
    async with async_session() as session:
        async with session.begin():
            ...
            return ShowUser(
                ...
                role_id = user.role_id,  # в алхимии другой UUID из алхимии
...
main_api_router.include_router(user_router, prefix="/user", tags=["user"]) # включаем user_router в main_api_router c путем "/user"
